<template>
  <div class="dropList page">
    <div class="main-wrap">
      <div class="drag-introdece">
        <span>Vue.Draggable：基于 Sortable.js 的 Vue 拖拽组件。 访问地址：</span>
          ...
          <div class="todo drag-box-item">
            ...
            <div class="drag-ul">
              <draggable v-model="todoList"  group="item" animation="300" >
                <transition-group>
                  <div v-for="item in todoList" v-bind:key="item.title" class="drag-item">
                    {{item.title}}
                  </div>
                </transition-group>
              </draggable>            </div>
          ...
          <div class="doing drag-box-item">
            ...
            <div class="drag-ul">
              <draggable v-model="doingList"  group="item" animation="300" >
                <transition-group>
                    <div v-for="item in doingList" v-bind:key="item.title" class="drag-item">
                      {{item.title}}
                    </div>
                  </transition-group>
                </draggable>
          ...
          <div class="done drag-box-item">
            ...
            <div class="drag-ul">
              <draggable v-model="doneList" group="item" animation="300" >
                <transition-group>
                  <div v-for="item in doneList" v-bind:key="item.title" class="drag-item">
                    {{item.title}}
                  </div>
                </transition-group>
              </draggable>
  ...
  data: function(){
    return {
      doneList:[
        {
          id: 1,
          title: '钟鼓馔玉不足贵，但愿长醉不愿醒。'
        },
                {
          id: 2,
          title: '古来圣贤皆寂寞，惟有饮者留其名。'
        },
        {
          id: 3,
